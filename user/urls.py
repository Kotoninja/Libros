...
urlpatterns = [
    ...
    path("reset_password/done/<uidb64>/<token>", views.reset_password_user, name="reset_password"),
    path("reset_password/email/", views.reset_password_user_request_to_email, name="reset_password_request_to_email"),
